...
3. Instalar la extensión **LIVE SERVER** para visualizar en tiempo real los cambios que haga al archivo `index.html`
    ...
    <details>
    <summary>📸 Haz clic aquí para ver la captura de pantalla</summary>
    <br>
    <img src="./screenshots/install-live-server.png" alt="Screenshot" width="100%">
    </details>
    ...
    <summary>📸 Haz clic aquí para ver la captura de pantalla</summary>
    <br>
    <img src="./screenshots/exec-live-server.png" alt="Screenshot" width="100%">
    </details>
## Licencia
